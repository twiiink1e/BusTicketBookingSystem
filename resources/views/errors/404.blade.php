...
<!-- Mirrored from codervent.com/syndash/demo/vertical/errors-404-error.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jul 2022 15:26:44 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8" />
	...
	<title>B-Bus</title>
	<!--favicon-->
	<link rel="icon" href="assets/images/newlogo.png" type="image/png" />
	<!-- loader-->
					...
					<div class="row g-0">
						<div class="col-lg-5">
							<div class="card-body p-5">
								...
								<div class="mt-5">
									<a href="/" class="btn btn-lg btn-info px-md-5 radius-30">Go Home</a>
